...
from chatgptapi_libs import getchatgpt_response
...
def main():
    ...
    chatgpt4minikey = os.getenv("OPENAI_API_KEY")
    ...
    if openai_api_key:
        print("Using CHATGPT for language model.")
        llm = ChatOpenAI(api_key=openai_api_key, model_name=openai_model_name, temperature=0.5)
    ...
    prompt =("""How does the author address the objection regarding the absence of a bill of rights in the proposed Constitution, and what comparisons does the author make with the Constitution of New York and the common and statute law of Great Britain?""")
